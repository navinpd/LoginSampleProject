package com.example.navin.loginsampleproject.Activity.utils;
...
public final class QLog {
     ...
     */
    private static final String TAG = "XpressMoney";
    /*
     * So any important logs can be outputted in non filtered output also
     */
    private static final String TAG_GENERAL_OUTPUT ="XpressMoney QLog";
